...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean PREFERENCE_UPDATE_FLAG = false;
    // TODO (4) Add a private static boolean PREFERENCE_UPDATE_FLAG for preference updates and initialize it to false
    ...
    private void openLocationInMap() {
        ...
        String addressString = getString(R.string.pref_location_default);
    ...
    // TODO (7) In onStart, if preferences have been changed, refresh the data and set the PREFERENCE_UPDATE_FLAG to false

    @Override
    protected void onStart() {
        super.onStart();
        if (PREFERENCE_UPDATE_FLAG) {
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);
            PREFERENCE_UPDATE_FLAG = false;
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        PREFERENCE_UPDATE_FLAG = true;
    }

    // TODO (5) Override onSharedPreferenceChanged to set the preferences PREFERENCE_UPDATE_FLAG to true
}